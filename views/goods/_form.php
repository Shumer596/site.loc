...
<div class="goods-form">
    ...
    <br>
    <h4><?= Yii::t('app', 'Goods') ?></h4>
    <?= $form->field($model, 'name')->textInput() ?>

    <?= $form->field($model, 'tare')->dropDownList(Goods::getTare(),
        ['prompt' => Yii::t('app', 'Select the tare')]) ?>
    ...
    <?= $form->field($model, 'work_preferences')->dropDownList(Transport::getPrefer(), [
